...
const SplashScreen = registerPlugin("SplashScreen", {
  web: () => __vitePreload(() => import("./web.dd872a7d.js"), true ? [] : void 0).then((m) => new m.SplashScreenWeb())
});
var CameraSource;
...
const Camera = registerPlugin("Camera", {
  web: () => __vitePreload(() => import("./web.313ceafa.js"), true ? [] : void 0).then((m) => new m.CameraWeb())
});
